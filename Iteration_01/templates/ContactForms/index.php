            ...
            <table class="table table-striped table-bordered align-middle">
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <span class="sort-icon">
                            <i class="fas fa-sort<?= ($this->request->getQuery('sort') === 'created') ?
                                ($this->request->getQuery('direction') === 'asc' ? '-up' : '-down') :
                                '' ?>"></i>
                        </span>
                    </th>
                ...
                <?php foreach ($contactForms as $contactForm): ?>
                    <tr>
                        ...
                        <td><?= h($contactForm->message) ?></td>
                        <td>
                            <div class="btn-group" role="group">
                                <?= $this->Html->link(__('View'), ['action' => 'view', $contactForm->id], ['class' => 'btn btn-warning btn-sm']) ?>
                                <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $contactForm->id], [
                                    'confirm' => __('Are you sure you want to delete Contact Form #{0 }?', $contactForm->id),
