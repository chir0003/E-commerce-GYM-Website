...
<nav class="navbar">
    <div class="navbar-container">
        ...
        <div class="desktop-nav d-none d-md-flex">
            <a href="<?= $this->Url->build(['controller' => 'Products', 'action' => 'shop', 'plugin' => null]) ?>" class="nav-link">Products</a>
            <a href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'services', 'plugin' => null]) ?>" class="nav-link">Services</a>
            <!--            <a href="#about" class="nav-link">About</a>-->
            <a href="<?= $this->Url->build(['controller' => 'ContactForms', 'action' => 'add']) ?>" class="nav-link">Contact Us</a>
            ...
            <div class="right-controls">
                ...
                <div class="cart-container position-relative">
                    <a href="<?= $this->Url->build(['controller' => 'orders', 'action' => 'viewCart']) ?>" class="cart-icon position-relative">
                        <i class="fa fa-shopping-cart fa-lg"></i>
                        <span id="cart-count" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                        <?= $this->getRequest()->getSession()->read('CartCount') ?? 0 ?>
                    </span>
                    </a>
                </div>
            </div>
        ...
        <div class="auth-container">
            ...
            <?php if ($identity): ?>
                <?= $this->Html->link('Logout', ['controller' => 'Auth', 'action' => 'logout'], ['class' => 'btn-auth btn-logout']) ?>
            <?php else: ?>
                <?= $this->Html->link('Login', ['controller' => 'Auth', 'action' => 'login'], ['class' => 'btn-auth btn-dark']) ?>
            <?php endif; ?>
        </div>
    </div>
</nav><!-- Mobile menu - hidden by default -->
<div id="mobileMenu" class="mobile-menu hidden p-3 bg-light d-md-none">
    <a href="<?= $this->Url->build(['controller' => 'Products', 'action' => 'shop']) ?>">Products</a>
    <a href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'services']) ?>">Services</a>
    <!--    <a href="#about">About</a>-->
    <a href="<?= $this->Url->build(['controller' => 'ContactForms', 'action' => 'add']) ?>">Contact Us</a>

    <!-- View Cart inside mobile menu -->
    <a href="<?= $this->Url->build(['controller' => 'orders', 'action' => 'viewCart']) ?>" class="position-relative">
